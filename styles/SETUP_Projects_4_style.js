var size = 0;
var placement = 'point';
function categories_SETUP_Projects_4(feature, value, size, resolution, labelText,
        ...
        image: new ol.style.Circle({radius: 9.0 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(35,35,35,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.0}), fill: new ol.style.Fill({color: 'rgba(60,179,113,1.0)'})}),
...
var style_SETUP_Projects_4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_SETUP_Projects_4(feature, value, size, resolution, labelText,
